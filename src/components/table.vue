<template>
  <div id="cTable" class="body">
    <div>
      <Table ref="table" :row-class-name="rowClass" :columns="columns" :data="table" :loading="loading" :border="showBorder" :stripe="showStripe"></Table>
      <div class="flex" style="margin-top:10px;">
      <p>
        <i-Switch v-model="showBorder"></i-Switch>显示边框&nbsp;
        <i-Switch v-model="showStripe"></i-Switch>显示斑马纹
      </p>
