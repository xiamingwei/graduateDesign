...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData1() {
        this.service.getTopic1PointData().then((response) => {
          this.datas1 = response.datas
        })
      },
      getData2() {
        this.service.getTopic1PointAnalyzeData1().then((response) => {
          this.datas2 = response.datas
        })
      },
      getData3() {
        this.service.getTopic1PointAnalyzeData2().then((response) => {
