...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData1() {
        this.service.getTopic3AgentData().then((response) => {
          this.datas1 = response.datas
        })
      },
      getData2() {
        this.service.getTopic3AgentAnalyzeData1().then((response) => {
          this.datas2 = response.datas
        })
      },
      getData3() {
        this.service.getTopic3AgentAnalyzeData2().then((response) => {
